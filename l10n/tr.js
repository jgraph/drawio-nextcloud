OC.L10N.register(
    "drawio",
    {
    "Versions plugin is not enabled" : "Sürümler uygulama eki etkinleştirilmemiş",
    "You can not open a folder" : "Bir klasör açamazsınız",
    "Invalid fileId/revId supplied." : "Belirtilen dosyaKodu/sürümKodu geçersiz.",
    "An internal server error occurred." : "Sunucuda bir sorun çıktı.",
    "Invalid fileId supplied." : "Belirtilen dosyaKodu geçersiz.",
    ...
    "Invalid fileId/shareToken supplied." : "Belirtilen alan/paylaşımKodu geçersiz.",
    ...
    "No" : "Hayır",
    "Language" : "Dil",
    "Activate offline mode in Draw.io?" : "Draw.io çevrimdışı kipi etkinleştirilsin",
    "When the \"offline mode\" is active, this disables all remote operations and features to protect the users privacy. Draw.io will then also only be in English, even if you set a different language manually." : "\"Çevrimdışı kip\" etkinleştirildiğinde, kullanıcıların gizliliğinin korunması için tüm uzaktan işlemler ve özellikler devre dışı bırakılır. Bu durumda el ile farklı bir dil ayarlasanız bile draw.io yalnızca İngilizce kullanılabilir.",
